...
| `abrir.html` | Página de entrada con enlaces a la captura (`index.html`), al cartel QR y al panel. Para el panel se pegan la dirección del prototipo y la URL del Apps Script, y lo abre en la vista «La voz de la Junta». |
